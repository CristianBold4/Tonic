...
public:
    ...
    static void read_node_oracle(std::string &oracle_filename, const char delimiter, int skip,
                                 emhash5::HashMap<int, int> &node_oracle);

    static void read_edge_oracle(std::string &oracle_filename, const char delimiter, int skip,
